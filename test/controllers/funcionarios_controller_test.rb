...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { bairro: @funcionario.bairro, celular: @funcionario.celular, cep: @funcionario.cep, email: @funcionario.email, endereco: @funcionario.endereco, fone: @funcionario.fone, funcao: @funcionario.funcao, login: @funcionario.login, nome: @funcionario.nome, senha: @funcionario.senha, uf: @funcionario.uf } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { bairro: @funcionario.bairro, celular: @funcionario.celular, cep: @funcionario.cep, email: @funcionario.email, endereco: @funcionario.endereco, fone: @funcionario.fone, funcao: @funcionario.funcao, login: @funcionario.login, nome: @funcionario.nome, senha: @funcionario.senha, uf: @funcionario.uf } }
